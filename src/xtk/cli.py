...
class XTKRepl:
    ...
    def complete(self, text, state):
        ...
        commands = [
            ...
            'rewrite', 'rw', 'eval', 'tree', 'trace',
            'rules', 'vars', 'latex', 'constant-folding'
        ]
...
```
    ...
    def load_rules(self, filename: str):
        ...
        try:
            ...
            self.console.print(f"[green]Loaded {len(new_rules)} rules from {filename}[/green]")
        except Exception as e:
    ...
    def add_rule(self, pattern_str: str, skeleton_str: str):
        ...
        try:
            ...
            # Add to rules
            self.rules.append([pattern, skeleton])
